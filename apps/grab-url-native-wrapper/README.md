...
the repository's own [`packages/grab-url/scripts/install-yt-dlp.mjs`](../../packages/grab-url/scripts/install-yt-dlp.mjs), which
...
"sidecar": {
  ...
  "build": "node ../../packages/grab-url/scripts/install-yt-dlp.mjs --sidecar --out {out}"
}
```
