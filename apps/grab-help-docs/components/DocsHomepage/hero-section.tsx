...
import { HeroVideo } from "@/components/DocsHomepage/hero-video"
    ...
    <section className="relative overflow-hidden border-b border-border">
      ...
      <KineticGrid variant="section" globalColor="auto" fill={false}>
        ...
        <div className="container mx-auto px-4 py-12 md:py-20 relative">
          {/* Hero copy on the left, demo video riding along on the right; the
              video stacks underneath the copy below `lg`. */}
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,30rem)] lg:items-center max-w-6xl mx-auto w-full">
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left w-full">
              ...
              <div className="flex flex-col sm:flex-row items-center lg:items-start gap-4 mb-4 lg:mb-0">
