...
the repository's own [`scripts/install-yt-dlp.mjs`](../grab-url/scripts/install-yt-dlp.mjs), which
...
"sidecar": {
  ...
  "build": "node ../grab-url/scripts/install-yt-dlp.mjs --sidecar --out {out}"
}
```
